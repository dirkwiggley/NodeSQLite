...
class DBRoles {
  constructor() {
    ...
    this.init = (res, next) => {
      try {
        let db = this.dbUtils.getDb()
        const create = db.prepare("CREATE TABLE IF NOT EXISTS roles (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT)")
        create.run()
